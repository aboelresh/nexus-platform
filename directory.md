Folder PATH listing
Volume serial number is B02F-09F2
C:.
|   .editorconfig
|   .env
|   .env.example
...
|   |       2026_07_12_231430_create_telescope_entries_table.php
|   |       2026_07_12_231844_create_permission_tables.php
|   |       
|   \---seeders
|           DatabaseSeeder.php
|           
...
|   |   |   |       pusher-with-encryption.min.js.LICENSE.txt
|   |   |   |       pusher-with-encryption.min.js.map
|   |   |   |       pusher.js
|   |   |   |       pusher.js.map
|   |   |   |       pusher.min.js
|   |   |   |       pusher.min.js.LICENSE.txt
|   |   |   |       pusher.min.js.map
|   |   |   |       sockjs.js
|   |   |   |       sockjs.min.js
|   |   |   |       
...
|   |   |           pusher-with-encryption.worker.min.js.LICENSE.txt
|   |   |           pusher-with-encryption.worker.min.js.map
|   |   |           pusher.worker.js
|   |   |           pusher.worker.js.map
|   |   |           pusher.worker.min.js
|   |   |           pusher.worker.min.js.LICENSE.txt
...
\---vendor
    ...
    |   |       |       MakeSearchable.php
    |   |       |       MakeSearchableUniquely.php
    |   |       |       RemoveableScoutCollection.php
    |   |       |       RemoveFromSearch.php
    |   |       |       RemoveFromSearchUniquely.php
    |   |       |       
    |   |       \---Traits
    |   |               ConfiguresJobOptions.php
    |   |               UniqueByScoutKeys.php
    |   |               
    |   +---sentinel
    |   |   |   composer.json
    |   |   |   
    ...
    |       |   |   
    |       |   +---Console
    |       |   |       AuditDriverCommand.php
    |       |   |       AuditResolverCommand.php
    |       |   |       InstallCommand.php
    |       |   |       
    |       |   +---Contracts
    |       |   |       AttributeEncoder.php
    |       |   |       AttributeModifier.php
    |       |   |       AttributeRedactor.php
    |       |   |       Audit.php
    |       |   |       Auditable.php
    |       |   |       AuditDriver.php
    |       |   |       Auditor.php
    ...
    |       |   |       Auditing.php
    |       |   |       DispatchAudit.php
    |       |   |       DispatchingAudit.php
    |       |   |       
    |       |   +---Exceptions
    |       |   |       AuditableTransitionException.php
    |       |   |       AuditingException.php
    |       |   |       
    |       |   +---Facades
    |       |   |       Auditor.php
    |       |   |       
    |       |   +---Listeners
    |       |   |       ProcessDispatchAudit.php
    |       |   |       RecordCustomAudit.php
    |       |   |       
    |       |   +---Models
    |       |   |       Audit.php
    |       |   |       
    ...
    |       |   \---Resolvers
    |       |           DumpResolver.php
    |       |           IpAddressResolver.php
    |       |           UrlResolver.php
    |       |           UserAgentResolver.php
    |       |           UserResolver.php
    |       |           
    |       \---stubs
    |               driver.stub
    ...
    |           |   |   |   |   +---Combine
    |           |   |   |   |   |       BaseCombine.php
    |           |   |   |   |   |       LinearCombineConfig.php
    |           |   |   |   |   |       RRFCombineConfig.php
    |           |   |   |   |   |       
    |           |   |   |   |   \---VectorSearch
    |           |   |   |   |           BaseVectorSearchConfig.php
    |           |   |   |   |           KNNVectorSearchConfig.php
    |           |   |   |   |           RangeVectorSearchConfig.php
    |           |   |   |   |           
    |           |   |   |   \---SchemaFields
    |           |   |   |           AbstractField.php
    |           |   |   |           FieldInterface.php
    ...
    |           |           
    |           +---Connection
    |           |   |   AbstractAggregateConnection.php
    ...
    |           |       |   
    |           |       \---Exception
    |           |               StreamInitException.php
    |           |               
    |           +---Consumer
    |           |   |   AbstractConsumer.php
    |           |   |   AbstractDispatcherLoop.php
    |           |   |   ConsumerInterface.php
    |           |   |   DispatcherLoopInterface.php
    |           |   |   
    |           |   +---PubSub
    |           |   |       Consumer.php
    |           |   |       DispatcherLoop.php
    ...
    |           |           Consumer.php
    |           |           DispatcherLoop.php
    |           |           PushNotificationException.php
    |           |           PushResponse.php
    |           |           PushResponseInterface.php
    |           |           
    |           +---Monitor
    |           |       Consumer.php
    |           |       
    ...
    |           |   |   
    |           |   +---Parser
    |           |   |   |   ParserStrategyResolver.php
    |           |   |   |   ParserStrategyResolverInterface.php
    ...
    |               |       
    |               +---Response
    |               |       BypassTransactionResponse.php
    |               |       
    |               \---Strategy
    |                       ClusterConnectionStrategy.php
    |                       ConnectionStrategyResolver.php
    |                       NodeConnectionStrategy.php
    |                       NonClusterConnectionStrategy.php
    |                       ReplicationConnectionStrategy.php
    |                       StrategyInterface.php
